        ...
        >
          ...
          >
            <span>
              ...
              <span style={{ color: "#d4d4d8" }}>Powered by RAILGUN</span>
          ...
          <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
            {(
              [
                { label: "Non-custodial", bg: "rgba(52,211,153,0.1)",  border: "rgba(52,211,153,0.3)",  text: "#34d399" },
                { label: "ZK proofs",     bg: "rgba(236,72,153,0.1)",  border: "rgba(236,72,153,0.3)",  text: "#f472b6" },
                { label: "No backend",    bg: "rgba(99,102,241,0.1)",  border: "rgba(99,102,241,0.3)",  text: "#818cf8" },
                { label: "4 chains",      bg: "rgba(63,63,70,0.4)",    border: "rgba(63,63,70,0.8)",    text: "#71717a" },
